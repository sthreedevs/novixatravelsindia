...
const Package = () => {
    ...
    return [
      {
        ...
        description:
          `Relax and unwind with a ${packageData.days} days stay at top hotels.`,
      },
      {
        icon: <FaRegClock size={24} />,
        title: `${packageData.nights} Nights`,
        description:
          `Stay for ${packageData.nights} unforgettable nights exploring the city.`,
      },
      {
        icon: <FaCity size={24} />,
  ...
  return (
    <div className="relative pt-30 w-full overflow-hidden">
      ...
      {packageData && customize && (
        <CustomizeModalForm packageData={packageData} setModal={setCustomize} />
      )}
    </div>
  );
};
