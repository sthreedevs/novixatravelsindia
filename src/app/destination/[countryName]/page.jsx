  ...
  const fetchData = async () => {
    ...
    try {
      const response = await axios.get(
        `/api/destination/getDestinationPageData/${countryName}`
      );
  ...
  return (
    <div className="py-20">
      ...
      <h1 className="text-3xl md:text-5xl font-medium text-center my-10">
        Places to visit in <span className="text-[#BFA181]">{countryName}</span>
      </h1>
  ...
  return (
    ...
    >
      ...
      >
        ...
        <Button
          className="mt-2"
          onClick={() => navigate(`/services/packages/${packageData._id}`)}
        >
          View Details
        </Button>
      </div>
