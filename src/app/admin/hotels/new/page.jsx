...
import { createHotel } from "@/lib/actions/admin/hotels.actions";
...
export default function NewHotelPage() {
  ...
  const [formData, setFormData] = useState({
    ...
    category: "", domesticPrice: "", internationalPrice: "", tags: ""
  });
        ...
        <div className="bg-white dark:bg-zinc-900 p-6 rounded-xl shadow-sm border border-gray-200 dark:border-zinc-800 space-y-6">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div className="md:col-span-2">
              ...
              <Input required name="title" value={formData.title} onChange={handleTextChange} placeholder="E.g. Taj Mahal Palace" />
            </div>
            <div>
            ...
            <div>
              ...
              <Input required name="city" value={formData.city} onChange={handleTextChange} placeholder="Mumbai" />
            </div>
            <div>
              <label className="block text-sm font-medium mb-1">State</label>
              <Input name="state" value={formData.state} onChange={handleTextChange} placeholder="Maharashtra" />
            </div>
            <div>
              <label className="block text-sm font-medium mb-1">Category *</label>
              <Input required name="category" value={formData.category} onChange={handleTextChange} placeholder="5 Star" />
            </div>
            <div>
              <label className="block text-sm font-medium mb-1">Domestic Price *</label>
              <Input required name="domesticPrice" value={formData.domesticPrice} onChange={handleTextChange} placeholder="15000" />
            </div>
            <div>
              <label className="block text-sm font-medium mb-1">International Price *</label>
              <Input required name="internationalPrice" value={formData.internationalPrice} onChange={handleTextChange} placeholder="200" />
            </div>
            <div className="md:col-span-2">
              <label className="block text-sm font-medium mb-1">Tags (comma separated)</label>
              <Input name="tags" value={formData.tags} onChange={handleTextChange} placeholder="Luxury, Sea View" />
            </div>
          </div>
