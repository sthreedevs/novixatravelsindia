...
export default function Stepper({
  ...
  return (
    ...
    >
      <div
        className={`mx-auto w-full max-w-4xl rounded-4xl shadow-xl ${stepCircleContainerClassName}`}
      ...
      >
        ...
        >
          ...
          <div
            onClick={() => dispatch(setModalForm(null))}
            className="hover:bg-neutral-50/10 p-1 rounded-md ml-4"
          >
            <X size={24} />
          </div>
        </div>
